      ...
      <form action="" method="POST" class="space-y-4">
        ...
        <div>
          ...
          <input type="text" id="title" name="title"
            class="w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:border-blue-500" required value="<?php echo $post['title']?>">
        </div>
        <?php 
        ?>
        <!-- Texto -->
        <div>
          ...
          <textarea id="message" name="message" rows="6"
            class="w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:border-blue-500"
             required><?php echo $post['message']?></textarea>
        </div>
